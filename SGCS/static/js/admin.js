...
$.Admin.maskInput = {
    maskEmpresa: function() {
        ...
        $(document).on('focus', 'input[name$="-telefone"]', function(){
            $(this).mask('(99) 9 9999-9999A', {translation:{'A': {pattern: /[0-9]/, optional: true}}}).focusout(function (event) {
                ...
                element.unmask();
                if(phone.length > 10) {
                    element.mask("(99) 9 9999-999A", {translation:{'A': {pattern: /[0-9]/, optional: true}}});
                } else {
    ...
    handleClienteInfo: function(data){
        ...
        if(typeof data === 'undefined' || !data){
            ...
            for(var i = 0; i < data.length; i++) {
                ...
                if(data[i].model == 'cadastro.paciente'){
                    $('#limite_credito_cliente').text(data[i].fields.limite_de_credito.replace(/\./g,','));
                    if(ind_ie == '1'){
                        $('#ind_ie_cliente').text('Contribuinte ICMS');
                    }else if(ind_ie == '2'){
...
$.Admin.lancamentoForm = {
    init: function(req_urls) {
        ...
        initializeSelect2Cliente($('#id_fornecedor'), '/cadastro/selectcliente');
        initializeSelect2Cliente($('#id_cliente'), '/cadastro/selectcliente');
