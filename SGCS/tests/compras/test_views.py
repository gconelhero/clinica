...
from SGCS.tests.test_case import BaseTestCase, replace_none_values_in_dictionary
from SGCS.apps.cadastro.models import Fornecedor, Produto
from SGCS.apps.compras.models import OrcamentoCompra, PedidoCompra, ItensCompra
from SGCS.apps.estoque.models import LocalEstoque, DEFAULT_LOCAL_ID
