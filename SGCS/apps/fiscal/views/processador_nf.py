...
from SGCS.apps.fiscal.models import NotaFiscalSaida, NotaFiscalEntrada, ConfiguracaoNotaFiscal, AutXML, \
...
from SGCS.apps.cadastro.models import COD_UF, PessoaJuridica, PessoaFisica, Fornecedor, Cliente, Empresa, Transportadora, Endereco, Telefone, Produto, Unidade
from SGCS.apps.compras.models import PedidoCompra, ItensCompra
from SGCS.apps.vendas.models import PedidoVenda, ItensVenda

from SGCS.apps.vendas.models import Pagamento as PagamentoVenda
