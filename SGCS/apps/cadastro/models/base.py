...
class Fazenda(models.Model):
    pessoa_faz = models.ForeignKey(Pessoa, related_name="fazenda", on_delete=models.CASCADE)
...
class Responsavel(models.Model):
    paciente = models.ForeignKey(Pessoa, related_name="responsavel", on_delete=models.CASCADE)
    nome = models.CharField(max_length=64, null=True, blank=True)
    cpf = models.CharField(max_length=32, null=True, blank=True)
    rg = models.CharField(max_length=32, null=True, blank=True)
    ...
    @property
    def format_endereco_completo(self):
        return '{0} - {1}'.format(self.nome, "Responsável por:\n" + self.paciente)
