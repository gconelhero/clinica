...
from SGCS.apps.cadastro.models import PessoaJuridica, PessoaFisica
...
class PessoaFisicaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'nascimento': forms.DateInput(attrs={'class': 'form-control datepicker', 'type':'date'}, format=('%Y-%m-%d')),
        }
        labels = {
            'cpf': _('CPF'),
            'rg': _('RG'),
