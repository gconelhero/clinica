...
urlpatterns = [
    ...
    # Paciente
    # cadastro/paciente/adicionar/
    path('paciente/adicionar/',
        views.AdicionarPacienteView.as_view(), name='addpacienteview'),
    # cadastro/paciente/listapacientes
    path('paciente/listapacientes/',
        views.PacientesListView.as_view(), name='listapacientesview'),
    # cadastro/paciente/editar/
    path('paciente/editar/<int:pk>/',
        views.EditarPacienteView.as_view(), name='editarpacienteview'),
    ...
    path('selectproduto/', views.SelectFormProduto.as_view(), name='selectproduto'),
    # Filtro Ajax+Select2 no form de produtos (filtrar por descrição e código)
    path('selectcliente/', views.SelectFormCliente.as_view(), name='selectcliente'),
    
    path('selectfornecedor/', views.SelectFormFornecedor.as_view(), name='selectfornecedor'),
    path('refreshform/', views.RefreshForm.as_view(), name='refreshform'),
    path('refreshformcompra/', views.RefreshForm.as_view(), name='refreshformcompra'),
]
