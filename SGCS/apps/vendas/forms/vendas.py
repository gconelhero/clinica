...
from SGCS.apps.vendas.models import OrcamentoVenda, PedidoVenda, ItensVenda, Venda
...
class ItensVendaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'produto': forms.Select(attrs={'class': 'form-control select-produto', 'style':'width:100%'}),
