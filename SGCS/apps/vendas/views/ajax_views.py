...
from SGCS.apps.vendas.models import PedidoVenda, CondicaoPagamento
from SGCS.apps.cadastro.models import Pessoa, Cliente, Fazenda, Endereco, Transportadora, Produto, Paciente
...
class InfoVenda(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        pedido_fields_dict = {}
        pedido_fields_dict['dest'] = venda.paciente.id
        try:
