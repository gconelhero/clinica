...
from SGCS.apps.fiscal.models import PIS, COFINS
from SGCS.apps.estoque.models import DEFAULT_LOCAL_ID
from SGCS.apps.cadastro.models import Fazenda, Produto
...
class Venda(models.Model):
    ...
    cliente = models.ForeignKey(
        'cadastro.Paciente', related_name="venda_cliente", on_delete=models.CASCADE)
    ...
    debitado = models.BooleanField(default=False, null=False, blank=False)
