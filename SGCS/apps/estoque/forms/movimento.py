...
from SGCS.apps.estoque.models import MovimentoEstoque, ItensMovimento, EntradaEstoque, SaidaEstoque, TransferenciaEstoque
...
class EntradaEstoqueForm(MovimentoForm):
    ...
    class Meta(MovimentoForm.Meta):
        ...
        fields = MovimentoForm.Meta.fields + \
            ('tipo_movimento', 'fornecedor', 'local_dest',)
