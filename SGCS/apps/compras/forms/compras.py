...
from SGCS.apps.compras.models import OrcamentoCompra, PedidoCompra, ItensCompra, Compra
...
class CompraForm(forms.ModelForm):
    ...
    class Meta:
        fields = ('data_emissao', 'fornecedor', 'mod_frete', 'desconto', 'tipo_desconto', 'frete', 'despesas', 
