...
class Entrada(Lancamento):
    cliente = models.ForeignKey('cadastro.Paciente', related_name="conta_cliente",
                                on_delete=models.DO_NOTHING, null=False, blank=False)
    #paciente = models.ForeignKey('cadastro.Paciente', related_name="conta_paciente",on_delete=models.SET_NULL, null=True, blank=True)
    ...
    creditado = models.BooleanField(null=False, blank=False, default=False)
...
class Saida(Lancamento):
    fornecedor = models.ForeignKey('cadastro.Paciente', related_name="conta_fornecedor", 
