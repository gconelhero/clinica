...
from SGCS.apps.financeiro.models import Saida, Entrada, STATUS_CONTA_ENTRADA_ESCOLHAS, STATUS_CONTA_SAIDA_ESCOLHAS
from SGCS.apps.financeiro.models import PlanoContasGrupo
from SGCS.apps.login.models import Usuario
from SGCS.apps.cadastro.models import MinhaEmpresa, Banco
...
class EntradaForm(LancamentoForm):
    ...
    class Meta(LancamentoForm.Meta):
        ...
        widgets['fornecedor'] = forms.Select(attrs={'class': 'form-control','style': 'width: 100%;'})
        widgets['cliente'] = forms.Select(attrs={'class': 'form-control', 'style': 'width: 100%;'})
        ...
        labels['data_pagamento'] = _('Data do Lançamento')
